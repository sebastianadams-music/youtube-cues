...
function loadClient() {
    gapi.client.setApiKey("AIzaSyD_M-nGZcJGGMKFEu_8Q012-t_3oOqJ_U8");
    ...
    .then(function(response) {
        ...
        if (listItems) {
            ...
            listItems.forEach(item => {
                ...
                output += `
                    <li><a onclick="pressed(event)" 
                    ><img data-href="https://www.youtube.com/watch?v=${videoId}" src="https://i3.ytimg.com/vi/${videoId}/hqdefault.jpg" /></a><p>${videoTitle}</p></li><br>
                `;
            });
            output += '</ul>';
...
function pressed(event){
    ...
    let text = event.target.dataset.href
    console.log(text)
